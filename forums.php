...
if ($action == "viewforum") {
	...
	if ($CURUSER)
		print ("<table cellpadding='0' cellspacing='5' width='100%'><tr><td><div align='right'><a href='forums.php?action=newtopic&amp;forumid=$forumid' class='button'> New Post </a></div></td></tr></table>");
