...
<style>
.admin-menu{display:grid;grid-template-columns:repeat(5,minmax(150px,1fr));gap:15px;width:100%;margin:20px auto 10px}
.admin-menu-card{position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:128px;padding:20px 12px 16px;box-sizing:border-box;border:1px solid rgba(127,127,127,.18);border-radius:14px;background:rgba(127,127,127,.055);color:inherit;text-decoration:none!important;overflow:hidden;isolation:isolate;transition:transform .22s ease,box-shadow .22s ease,border-color .22s ease,background .22s ease}
.admin-menu-card:before{content:"";position:absolute;inset:0 0 auto 0;height:4px;background:var(--tile-color);z-index:-1}
.admin-menu-card:after{content:"";position:absolute;inset:0;background:var(--tile-color);opacity:0;z-index:-2;transition:opacity .22s ease}
.admin-menu-card:hover,.admin-menu-card:focus-visible{transform:translateY(-6px);border-color:var(--tile-color);box-shadow:0 12px 28px rgba(0,0,0,.16);outline:none}
.admin-menu-card:hover:after,.admin-menu-card:focus-visible:after{opacity:.07}
.admin-menu-icon{display:flex;align-items:center;justify-content:center;width:58px;height:58px;margin-bottom:13px;border-radius:16px;background:color-mix(in srgb,var(--tile-color) 12%,transparent);color:var(--tile-color);font-size:26px;box-shadow:0 2px 8px rgba(0,0,0,.05);transition:transform .22s ease,background .22s ease,color .22s ease,box-shadow .22s ease}
.admin-menu-card:hover .admin-menu-icon,.admin-menu-card:focus-visible .admin-menu-icon{transform:scale(1.12) rotate(-3deg);background:var(--tile-color);color:#fff;box-shadow:0 7px 18px color-mix(in srgb,var(--tile-color) 35%,transparent)}
.admin-menu-label{font-size:13px;line-height:1.35;font-weight:600;text-align:center}
@media(max-width:1050px){.admin-menu{grid-template-columns:repeat(4,minmax(135px,1fr))}}
@media(max-width:780px){.admin-menu{grid-template-columns:repeat(3,minmax(120px,1fr));gap:11px}}
@media(max-width:560px){.admin-menu{grid-template-columns:repeat(2,minmax(120px,1fr))}.admin-menu-card{min-height:112px}}
@media(max-width:360px){.admin-menu{grid-template-columns:1fr}}
</style>
<div class="admin-menu">
<a class="admin-menu-card" style="--tile-color:#4f46e5" href="admincp.php?action=usersearch"><span class="admin-menu-icon"><i class="fa-solid fa-users" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("ADVANCED_USER_SEARCH"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#8b5cf6" href="admincp.php?action=avatars"><span class="admin-menu-icon"><i class="fa-solid fa-user-astronaut" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("AVATAR_LOG"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#0891b2" href="admincp.php?action=backups"><span class="admin-menu-icon"><i class="fa-solid fa-database" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("BACKUPS"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#ef4444" href="admincp.php?action=ipbans"><span class="admin-menu-icon"><i class="fa-solid fa-ban" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("BANNED_IPS"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#f97316" href="admincp.php?action=bannedtorrents"><span class="admin-menu-icon"><i class="fa-solid fa-file-circle-xmark" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("BANNED_TORRENTS"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#14b8a6" href="admincp.php?action=blocks&amp;do=view"><span class="admin-menu-icon"><i class="fa-solid fa-cubes" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("BLOCKS"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#dc2626" href="admincp.php?action=cheats"><span class="admin-menu-icon"><i class="fa-solid fa-user-shield" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("DETECT_POSS_CHEATS"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#06b6d4" href="admincp.php?action=emailbans"><span class="admin-menu-icon"><i class="fa-solid fa-envelope-circle-xmark" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("EMAIL_BANS"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#6366f1" href="faq-manage.php"><span class="admin-menu-icon"><i class="fa-solid fa-circle-question" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("FAQ"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#eab308" href="admincp.php?action=freetorrents"><span class="admin-menu-icon"><i class="fa-solid fa-gift" aria-hidden="true"></i></span><span class="admin-menu-label">Freeleech Torrents</span></a>
<a class="admin-menu-card" style="--tile-color:#22c55e" href="admincp.php?action=lastcomm"><span class="admin-menu-icon"><i class="fa-solid fa-comments" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("LATEST_COMMENTS"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#0ea5e9" href="admincp.php?action=masspm"><span class="admin-menu-icon"><i class="fa-solid fa-paper-plane" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("MASS_PM"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#64748b" href="admincp.php?action=messagespy"><span class="admin-menu-icon"><i class="fa-solid fa-user-secret" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("MESSAGE_SPY"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#f59e0b" href="admincp.php?action=news&amp;do=view"><span class="admin-menu-icon"><i class="fa-solid fa-newspaper" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("NEWS"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#10b981" href="admincp.php?action=peers"><span class="admin-menu-icon"><i class="fa-solid fa-network-wired" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("PEERS_LIST"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#a855f7" href="admincp.php?action=polls&amp;do=view"><span class="admin-menu-icon"><i class="fa-solid fa-square-poll-vertical" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("POLLS"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#f43f5e" href="admincp.php?action=reports&amp;do=view"><span class="admin-menu-icon"><i class="fa-solid fa-flag" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("REPORTS"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#7c3aed" href="admincp.php?action=rules&amp;do=view"><span class="admin-menu-icon"><i class="fa-solid fa-scale-balanced" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("RULES"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#475569" href="admincp.php?action=sitelog"><span class="admin-menu-icon"><i class="fa-solid fa-list-check" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("SITELOG"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#ec4899" href="teams-create.php"><span class="admin-menu-icon"><i class="fa-solid fa-users-gear" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("TEAMS"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#6366f1" href="admincp.php?action=style"><span class="admin-menu-icon"><i class="fa-solid fa-palette" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("THEME_MANAGEMENT"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#0284c7" href="admincp.php?action=categories&amp;do=view"><span class="admin-menu-icon"><i class="fa-solid fa-folder-tree" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("TORRENT_CAT_VIEW"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#16a34a" href="admincp.php?action=torrentlangs&amp;do=view"><span class="admin-menu-icon"><i class="fa-solid fa-language" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("TORRENT_LANG"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#2563eb" href="admincp.php?action=torrentmanage"><span class="admin-menu-icon"><i class="fa-solid fa-tower-broadcast" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("TORRENTS"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#9333ea" href="admincp.php?action=groups&amp;do=view"><span class="admin-menu-icon"><i class="fa-solid fa-user-group" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("USER_GROUPS_VIEW"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#f97316" href="admincp.php?action=warned"><span class="admin-menu-icon"><i class="fa-solid fa-user-large-slash" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("WARNED_USERS"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#06b6d4" href="admincp.php?action=whoswhere"><span class="admin-menu-icon"><i class="fa-solid fa-location-dot" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("WHOS_WHERE"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#dc2626" href="admincp.php?action=censor"><span class="admin-menu-icon"><i class="fa-solid fa-filter-circle-xmark" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("WORD_CENSOR"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#0f766e" href="admincp.php?action=forum"><span class="admin-menu-icon"><i class="fa-solid fa-comments" aria-hidden="true"></i></span><span class="admin-menu-label"><?php echo T_("FORUM_MANAGEMENT"); ?></span></a>
<a class="admin-menu-card" style="--tile-color:#4f46e5" href="admincp.php?action=users"><span class="admin-menu-icon"><i class="fa-solid fa-user-magnifying-glass" aria-hidden="true"></i></span><span class="admin-menu-label">Simple User Search</span></a>
<a class="admin-menu-card" style="--tile-color:#0891b2" href="admincp.php?action=privacylevel"><span class="admin-menu-icon"><i class="fa-solid fa-user-lock" aria-hidden="true"></i></span><span class="admin-menu-label">Privacy Level</span></a>
<a class="admin-menu-card" style="--tile-color:#eab308" href="admincp.php?action=pendinginvite"><span class="admin-menu-icon"><i class="fa-solid fa-user-clock" aria-hidden="true"></i></span><span class="admin-menu-label">Pending Invited Users</span></a>
<a class="admin-menu-card" style="--tile-color:#22c55e" href="admincp.php?action=invited"><span class="admin-menu-icon"><i class="fa-solid fa-user-plus" aria-hidden="true"></i></span><span class="admin-menu-label">Invited Users</span></a>
<a class="admin-menu-card" style="--tile-color:#ef4444" href="admincp.php?action=sqlerr"><span class="admin-menu-icon"><i class="fa-solid fa-triangle-exclamation" aria-hidden="true"></i></span><span class="admin-menu-label">SQL Error</span></a>
</div>
